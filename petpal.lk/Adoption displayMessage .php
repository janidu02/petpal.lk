          ...
          <div class="tablecontain-inner">
            ...
            <table class="content-table">
                ...
                <tbody>
                  ...
                  $sql = "Select * from adoption where Email='$email'";
                  ...
                  if($result){
                    while($row = mysqli_fetch_assoc($result)){
                      ...
                      <td>'.$Request.'</td>
                      <td>
                       <button class="ctn"><a href="Adoption edit.php?email='.$Email.'">Edit</a></button>
                       <button class="ctn"><a href="Adoption delete .php?deleteid='.$ID.'" >Delete</a></button>
                      </td>
              ...
              <div class="dlst"> <a href="Adoption Request.html" class="ctn">Back</a></div>
